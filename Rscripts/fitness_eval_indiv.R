#######################################################################
# Routines for evaluating fitness function for each individual system;
# different from fitness_eval.R by not having the weighted.mean command 
# on the last line of each function
#######################################################################
